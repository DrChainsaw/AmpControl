...
public class EvolvingGraphAdapter implements ModelAdapter, Evolving<EvolvingGraphAdapter> {
    ...
    public EvolvingGraphAdapter evolve() {
        log.info("listeners: " + graph.getListeners().size() + ": " + graph.getListeners());
        ...
        return new EvolvingGraphAdapter(parameterTransfer.transferWeightsTo(mutated.build()), mutation);
    }
}
